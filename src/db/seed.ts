...
async function seed() {
  ...
  const matchesData: MatchData[] = [
    ...
    },
    {
      ...
      scheduledAt: new Date("2026-06-20T01:00:00Z"),
      status: "scheduled",
    },
    {
      matchNumber: 18,
    ...
    },
    {
      ...
      awayTeamCode: "PAR",
      venueCity: "Santa Clara",
      scheduledAt: new Date("2026-06-20T04:00:00Z"),
      status: "scheduled",
    },
    {
      matchNumber: 31,
    ...
    // Round of 32 (Matches 73-88) - June 28 - July 3, 2026
    {
      matchNumber: 73,
      stageSlug: "round_of_32",
      homeTeamCode: "RSA",
      awayTeamCode: "CAN",
      venueCity: "Inglewood",
    ...
    },
    {
      ...
      awayTeamCode: "PAR",
      venueCity: "Foxborough",
      scheduledAt: new Date("2026-06-29T16:30:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 75,
      ...
      awayTeamCode: "MAR",
      venueCity: "Monterrey",
      scheduledAt: new Date("2026-06-29T19:00:00-06:00"),
      status: "scheduled",
    },
    {
      matchNumber: 76,
      ...
      awayTeamCode: "JPN",
      venueCity: "Houston",
      scheduledAt: new Date("2026-06-29T12:00:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 77,
      ...
      awayTeamCode: "SWE",
      venueCity: "East Rutherford",
      scheduledAt: new Date("2026-06-30T17:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 78,
      ...
      awayTeamCode: "NOR",
      venueCity: "Arlington",
      scheduledAt: new Date("2026-06-30T12:00:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 79,
      stageSlug: "round_of_32",
      homeTeamCode: "MEX",
      awayTeamPlaceholder: "Best 3rd (C/E)",
      venueCity: "Mexico City",
      scheduledAt: new Date("2026-06-30T19:00:00-06:00"),
      status: "scheduled",
    },
    {
      matchNumber: 80,
      stageSlug: "round_of_32",
      homeTeamPlaceholder: "Winner Group L",
      awayTeamPlaceholder: "Best 3rd (I/J/K)",
      venueCity: "Atlanta",
      scheduledAt: new Date("2026-06-30T12:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 81,
      ...
      awayTeamCode: "BIH",
      venueCity: "Santa Clara",
      scheduledAt: new Date("2026-07-01T17:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 82,
      stageSlug: "round_of_32",
      homeTeamCode: "BEL",
      awayTeamPlaceholder: "Best 3rd (A/I/J)",
      venueCity: "Seattle",
      scheduledAt: new Date("2026-07-01T13:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 83,
      stageSlug: "round_of_32",
      homeTeamPlaceholder: "Runner-up Group K",
      awayTeamPlaceholder: "Runner-up Group L",
      venueCity: "Toronto",
      scheduledAt: new Date("2026-07-02T19:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 84,
      stageSlug: "round_of_32",
      homeTeamCode: "ESP",
      awayTeamPlaceholder: "Runner-up Group J",
      venueCity: "Inglewood",
      scheduledAt: new Date("2026-07-02T12:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 85,
      stageSlug: "round_of_32",
      homeTeamCode: "SUI",
      awayTeamPlaceholder: "Best 3rd (G/J)",
      venueCity: "Vancouver",
      scheduledAt: new Date("2026-07-02T20:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 86,
      ...
      awayTeamCode: "CPV",
      venueCity: "Miami Gardens",
      scheduledAt: new Date("2026-07-03T18:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 87,
      stageSlug: "round_of_32",
      homeTeamPlaceholder: "Winner Group K",
      awayTeamPlaceholder: "Best 3rd (E/I/L)",
      venueCity: "Kansas City",
      scheduledAt: new Date("2026-07-03T20:30:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 88,
      ...
      awayTeamCode: "EGY",
      venueCity: "Arlington",
      scheduledAt: new Date("2026-07-03T13:00:00-05:00"),
      status: "scheduled",
    },
    // Round of 16 (Matches 89-96) - July 4-7, 2026
    {
      matchNumber: 89,
      stageSlug: "round_of_16",
      homeTeamPlaceholder: "Winner GER/PAR",
      awayTeamPlaceholder: "Winner FRA/SWE",
      venueCity: "Foxborough",
      scheduledAt: new Date("2026-07-04T17:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 90,
      stageSlug: "round_of_16",
      homeTeamPlaceholder: "Winner RSA/CAN",
      awayTeamPlaceholder: "Winner NED/MAR",
      venueCity: "Inglewood",
      scheduledAt: new Date("2026-07-04T13:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 91,
      stageSlug: "round_of_16",
      homeTeamPlaceholder: "Winner BRA/JPN",
      awayTeamPlaceholder: "Winner CIV/NOR",
      venueCity: "Kansas City",
      scheduledAt: new Date("2026-07-05T16:00:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 92,
      stageSlug: "round_of_16",
      homeTeamPlaceholder: "Winner Match 79",
      awayTeamPlaceholder: "Winner Match 80",
      venueCity: "Atlanta",
      scheduledAt: new Date("2026-07-05T20:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 93,
      stageSlug: "round_of_16",
      homeTeamPlaceholder: "Winner Match 83",
      awayTeamPlaceholder: "Winner Match 84",
      venueCity: "Miami Gardens",
      scheduledAt: new Date("2026-07-06T15:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 94,
      stageSlug: "round_of_16",
      homeTeamPlaceholder: "Winner USA/BIH",
      awayTeamPlaceholder: "Winner Match 82",
      venueCity: "Houston",
      scheduledAt: new Date("2026-07-06T20:00:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 95,
      stageSlug: "round_of_16",
      homeTeamPlaceholder: "Winner ARG/CPV",
      awayTeamPlaceholder: "Winner AUS/EGY",
      venueCity: "Philadelphia",
      scheduledAt: new Date("2026-07-07T12:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 96,
      stageSlug: "round_of_16",
      homeTeamPlaceholder: "Winner Match 85",
      awayTeamPlaceholder: "Winner Match 87",
      venueCity: "Arlington",
      scheduledAt: new Date("2026-07-07T16:00:00-05:00"),
      status: "scheduled",
    },
    // Quarter-finals (Matches 97-100) - July 9-11, 2026
    {
      matchNumber: 97,
      ...
      venueCity: "Inglewood",
      scheduledAt: new Date("2026-07-09T16:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 98,
      ...
      venueCity: "Kansas City",
      scheduledAt: new Date("2026-07-10T15:00:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 99,
      ...
      venueCity: "Miami Gardens",
      scheduledAt: new Date("2026-07-11T17:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 100,
      ...
      venueCity: "Atlanta",
      scheduledAt: new Date("2026-07-11T21:00:00-04:00"),
      status: "scheduled",
    },
    // Semi-finals (Matches 101-102) - July 14-15, 2026
    {
      matchNumber: 101,
    ...
    // Bronze Final (Match 103) - July 18, 2026
    {
      matchNumber: 103,
  ...
  console.log(`✅ Inserted ${resolvedMatches.length} matches`);
