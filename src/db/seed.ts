...
async function seed() {
  ...
  const matchesData: MatchData[] = [
    ...
    },
    {
      ...
      awayTeamPlaceholder: "3 ABCDF",
      venueCity: "Arlington",
      scheduledAt: new Date("2026-06-28T16:30:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 75,
      ...
      venueCity: "East Rutherford",
      scheduledAt: new Date("2026-06-28T21:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 76,
      ...
      venueCity: "Kansas City",
      scheduledAt: new Date("2026-06-29T13:00:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 77,
      ...
      awayTeamPlaceholder: "3 CDFGH",
      venueCity: "Foxborough",
      scheduledAt: new Date("2026-06-29T17:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 78,
    ...
    },
    {
      ...
      stageSlug: "round_of_32",
      homeTeamPlaceholder: "1A",
      awayTeamPlaceholder: "3 CEFHI",
      venueCity: "Toronto",
      scheduledAt: new Date("2026-06-29T21:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 80,
    ...
    },
    {
      ...
      awayTeamPlaceholder: "3 BEFIJ",
      venueCity: "Inglewood",
      scheduledAt: new Date("2026-06-30T20:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 82,
    ...
    },
    {
      matchNumber: 83,
      stageSlug: "round_of_32",
      homeTeamPlaceholder: "2K",
      awayTeamPlaceholder: "2L",
      venueCity: "Miami Gardens",
      scheduledAt: new Date("2026-07-01T19:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 84,
    ...
    },
    {
      ...
      awayTeamPlaceholder: "3 EFGIJ",
      venueCity: "Seattle",
      scheduledAt: new Date("2026-07-02T23:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 86,
      ...
      venueCity: "Philadelphia",
      scheduledAt: new Date("2026-07-02T13:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 87,
      stageSlug: "round_of_32",
      homeTeamPlaceholder: "1K",
      awayTeamPlaceholder: "3 DEIJL",
      venueCity: "Miami Gardens",
      scheduledAt: new Date("2026-07-03T21:30:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 88,
      stageSlug: "round_of_32",
      homeTeamPlaceholder: "2D",
      awayTeamPlaceholder: "2G",
      venueCity: "Houston",
      scheduledAt: new Date("2026-07-03T14:00:00-05:00"),
      status: "scheduled",
    },
    // Round of 16 (Matches 89-96) - July 4-7, 2026
    {
      ...
      homeTeamPlaceholder: "W74",
      awayTeamPlaceholder: "W77",
      venueCity: "Foxborough",
