...
async function seed() {
  ...
  const matchesData: MatchData[] = [
    ...
    },
    {
      ...
      awayTeamCode: "MAR",
      venueCity: "Houston",
      scheduledAt: new Date("2026-07-04T12:00:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 91,
      ...
      awayTeamCode: "NOR",
      venueCity: "East Rutherford",
      scheduledAt: new Date("2026-07-05T16:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 92,
      ...
      awayTeamCode: "ENG",
      venueCity: "Mexico City",
      scheduledAt: new Date("2026-07-05T18:00:00-06:00"),
      status: "scheduled",
    },
    {
      matchNumber: 93,
      ...
      awayTeamCode: "ESP",
      venueCity: "Arlington",
      scheduledAt: new Date("2026-07-06T14:00:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 94,
      ...
      awayTeamCode: "BEL",
      venueCity: "Seattle",
      scheduledAt: new Date("2026-07-06T17:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 95,
    ...
    },
    {
      ...
      awayTeamCode: "COL",
      venueCity: "Vancouver",
      scheduledAt: new Date("2026-07-07T13:00:00-07:00"),
      status: "scheduled",
    },
    // Quarter-finals (Matches 97-100) - July 9-11, 2026
    {
      ...
      awayTeamCode: "MAR",
      venueCity: "Foxborough",
      scheduledAt: new Date("2026-07-09T16:00:00-04:00"),
      status: "scheduled",
    },
    {
      matchNumber: 98,
      ...
      awayTeamCode: "BEL",
      venueCity: "Inglewood",
      scheduledAt: new Date("2026-07-10T12:00:00-07:00"),
      status: "scheduled",
    },
    {
      matchNumber: 99,
    ...
    },
    {
      ...
      awayTeamCode: "SUI",
      venueCity: "Kansas City",
      scheduledAt: new Date("2026-07-11T20:00:00-05:00"),
      status: "scheduled",
    },
    // Semi-finals (Matches 101-102) - July 14-15, 2026
    {
      ...
      awayTeamCode: "ESP",
      venueCity: "Arlington",
      scheduledAt: new Date("2026-07-14T14:00:00-05:00"),
      status: "scheduled",
    },
    {
      matchNumber: 102,
